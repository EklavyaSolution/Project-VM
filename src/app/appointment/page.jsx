...
const Appointment = () => {
  ...
  return (
    <div className='bg-[#FFFBF6] w-full h-full min-h-screen pb-12'>
      ...
      <div className='w-full bg-[#FFF3E0CC] pb-12 pt-8 mt-12 px-5'>
        <div className='w-full mx-auto max-w-[1100px] flex max-[580px]:flex-col justify-between items-center'>
