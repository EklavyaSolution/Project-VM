  ...
  return (
    <div className='bg-[#FFFBF6] w-full h-full min-h-screen'>
      ...
      <div className='w-full mx-auto max-w-[1200px] mt-10'>
        ...
        <p className='text-center font-normal mt-4 mb-12'>Explore life's secrets with Venky Musti. Harmony and clarity await as you delve into the profound world of AstroNumerology. Best Marriage And Love Compatibility Consultation In Dubai.</p>
