    ...
    return (
        <div className='bg-[#FFFBF6] w-full h-full min-h-screen'>
            <div className='w-full grid place-items-center h-48 lg:h-52  2xl:h-56 bg-sky-500 '>
                <h1 className='text-white font-semibold text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-[40px]'>Physhic Number in Numerology</h1>
            </div>
            <div className='w-full mx-auto max-w-[1200px] mt-6'>
                <h2 className='text-center font-semibold text-[#100E6A] md:text-lg lg:text-xl xl:text-3xl 2xl:text-4xl leading-4'>Physhic Number</h2>
                <h5 className='text-center text-[#EA8427] font-semibold text-xl mt-2 tracking-wide'>Physhic Number is an important Number in Numerology. It is helpful in the long-term planning of events.</h5>
                <div className='w-full px-12 py-8 flex gap-12 bg-[#FFEECE] mt-8'>
                    ...
                    <div>
                        <h2 className='text-[#100E6A] font-semibold text-2xl leading-5 mb-4'>What is Physhic Number?</h2>
                ...
                <div className='w-full px-12 py-8 flex gap-12 bg-[#FFEECE] mt-8'>
                    ...
                    <div>
                        <h2 className='text-[#100E6A] font-semibold text-2xl leading-5 mb-4'>How to Calculate Physhic Number?</h2>
                        <p className='w-[740px] font-normal leading-[1.32rem]'>Destiny Number / Bhagyank number is calculated by adding the person's date of birth and then reducing the obtained number into a single-digit number. Refer to the below example to calculate your Destiny Number.</p>
            ...
            <div className='w-full px-12 mb-16'>
                <h3 className='text-center font-semibold text-[#100E6A] md:text-lg lg:text-xl xl:text-3xl 2xl:text-4xl leading-4 mb-12'>Physhic Numbers</h3>
                <div className='flex flex-wrap items-center justify-center gap-10'>
                    <div className='w-[250px] rounded overflow-hidden bg-white shadow-[0_0px_10px_0px_rgba(0,0,0,0.25)]'>
                        ...
                        <h3 className='py-3 text-center font-semibold text-lg'>Physhic Number 01</h3>
                    </div>
                    <div className='w-[250px] rounded overflow-hidden bg-white shadow-[0_0px_10px_0px_rgba(0,0,0,0.25)]'>
                        <Image src={num1} alt='' className='w-full object-cover' />
                        <h3 className='py-3 text-center font-semibold text-lg'>Physhic Number 01</h3>
