...
const Footer = () => {
  return (
    <footer className='w-full p-12 pb-5 bg-gradient-to-b from-[#9241d8] to-[#15138c] text-white'>
      <div className='flex justify-between'>
        <div className='px-12'>
          ...
          <h4 className='text-[#EEE6FB] mb-3 font-semibold tracking-wider'>Social Media</h4>
        ...
        <div className='mr-20'>
          <div className='flex gap-32'>
            <div className='font-medium tracking-wide'>
              <h2 className='font-semibold mb-3 tracking-wider'>Consultation</h2>
            ...
            <div className='font-medium tracking-wide'>
              <h2 className='font-semibold mb-3 tracking-wider'>Quick Links</h2>
          ...
          <div className='font-medium mt-6 tracking-wide'>
            <h2 className='font-semibold mb-3 tracking-wider'>Contact Us</h2>
